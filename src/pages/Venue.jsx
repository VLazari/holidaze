			...
			<div className="pt-6">
				...
				{/* <div className="mx-auto mt-6 max-w-2xl sm:px-6 lg:grid lg:max-w-7xl lg:grid-cols-1 lg:gap-x-8 lg:px-8">
					<div className="aspect-h-4 aspect-w-6 lg:aspect-h-2 lg:aspect-w-3 sm:overflow-hidden sm:rounded-lg">
						<img src={product.images[3].src} alt={product.images[3].alt} className="h-full w-full object-contain object-center" />
					</div>
				</div> */}
				...
				<div className="mx-auto max-w-2xl px-4 pb-16 pt-10 sm:px-6 lg:grid lg:max-w-7xl lg:grid-cols-3 lg:grid-rows-[auto,auto,1fr] lg:gap-x-8 lg:px-8 lg:pb-24 lg:pt-16">
					...
					<div className="mt-4 lg:row-span-3 lg:mt-0">
						...
						<form className="mt-10">
							...
							<button
								type="submit"
								className="mt-10 flex w-full items-center justify-center rounded-md border border-transparent bg-gold-main px-8 py-3 text-base font-medium text-blue-main outline-none hover:ring-2 hover:ring-blue-main ring-offset-1"
							>
								Book now
							</button>
						</form>
