...
const schema = yup
  .object({
    ...
    description: yup
      .string()
      .trim()
      .required('Please enter the venue description'),
    venueImage: yup
      .array()
    ...
    price: yup
      ...
      .min(1, 'Please set a correct price. Minimum $1'),
...
export default function AddVenue() {
  ...
  const onSubmit = async (data) => {
    ...
    response && response.id
      ? navigate(`/profiles/${userData.name}/venues`)
      : setIsError(true);
  };
    ...
    <form className="p-2 md:p-5" onSubmit={handleSubmit(onSubmit)}>
      <div className="space-y-12 p-5">
        <div className="border-b border-gray-900/10 pb-12">
          <h1 className="text-center text-2xl md:text-4xl font-bold text-blue-main">
            Add venue
          </h1>
        ...
        <div className="border-b border-gray-900/10 pb-12">
          ...
          <p className="mt-1 text-sm leading-6 text-gray-600">
            Set price, maximum number of guests and location.
          </p>
          <div className="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
        ...
        <div className="border-b border-gray-900/10 pb-12">
          ...
          <p className="mt-1 text-sm leading-6 text-gray-600">
            Are any of the below features included.
          </p>
