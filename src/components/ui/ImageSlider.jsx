...
export default function ImageSlider({ venue }) {
  const { media } = venue;
  ...
  if (media.length) {
    return (
      <div className="mx-auto mt-6 max-w-3xl sm:px-6 lg:px-8">
        <div className="relative mx-auto mt-6 max-w-2xl sm:px-6 lg:px-8 bg-blue-main/25">
          <div
            className="absolute top-o left-0 h-full w-1/4 z-10 bg-black/0 cursor-pointer"
          ...
          <div
            className="absolute top-o right-0 h-full w-1/4 z-10 bg-black/0 cursor-pointer"
        ...
        <div className="flex justify-center flex-wrap">
          {media.map((img, index) => (
            <div
              key={index}
              className="mx-2 mt-2 h-14 w-14 border cursor-pointer"
    ...
    return (
      <div className="mx-auto mt-6 max-w-3xl sm:px-6 lg:px-8">
        ...
        <div className="flex justify-center flex-wrap">
          <div className="mx-2 mt-2 h-14 w-14 border cursor-pointer">
            <HomeModernIcon className="h-full w-full object-contain object-center" />
          </div>
        </div>
      </div>
