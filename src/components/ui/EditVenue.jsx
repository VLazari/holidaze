...
const schema = yup
  .object({
    ...
    venueImage: yup
      .array()
      .of(yup.string().trim().url('Should be a valid image URL.')),
    price: yup
      .mixed()
      .test(
        'price',
        'The price must be a number greater than 1',
        (val) => val === '' || yup.number().min(1).isValidSync(val)
      ),
    maxGuests: yup
      .mixed()
      .test(
    ...
    <form className="p-2 md:p-5" onSubmit={handleSubmit(onSubmit)}>
      <div className="space-y-12 p-5">
        <div className="border-b border-gray-900/10 pb-12">
          <h1 className="text-center text-base font-bold leading-7 text-blue-main">
            Edit venue
          </h1>
          <p className="mt-5 text-sm leading-6 text-gray-600">
            Complete the fields to edit.
          </p>
          <div className="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
            ...
            <div className="col-span-full">
              ...
              <p className="text-sm text-red-main">
          ...
          {Array.from({ length: nrOfImages }, (_, index) => (
            <div key={index} className="mt-5 sm:col-span-4">
              ...
              <div className="mt-2">
                ...
                <p className="text-sm text-red-main">
                  {errors.venueImage?.[index]?.message}
                </p>
              </div>
            </div>
          ))}
        ...
        <div className="border-b border-gray-900/10 pb-12">
          ...
          <p className="mt-1 text-sm leading-6 text-gray-600">
            Edit price or maximum number of guests.
          </p>
          <div className="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
        ...
        <div className="border-b border-gray-900/10 pb-12">
          ...
          <p className="mt-1 text-sm leading-6 text-red-main">
            Make sure to include all existing feature on edit.
          </p>
        ...
        {isError && (
          <p className="text-center text-md font-semibold text-red-main">
            Something went wrong, please check the data you entered and try
            again
          </p>
        )}
      </div>
