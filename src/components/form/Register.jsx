...
const schema = yup
  .object({
    userName: yup
      ...
      .matches(
        /^[\w_]+$/,
        'Name value must not contain punctuation symbols apart from underscore (_).'
      )
    ...
    emailAddress: yup
      ...
      .matches(
        ...
        'Please enter a valid stud.noroff.no or noroff.no email address.'
      )
                        ...
                        <div className="grid grid-cols-6 gap-6">
                          ...
                          <div className="col-span-6">
                            <label
                              ...
                              className="block text-sm font-medium leading-6 text-blue-main"
                            >
                              <span className="text-red-main">*</span> Confirm
                              Password
                            </label>
                            <input
                            ...
                            <div className="flex gap-x-3">
                              ...
                              <div className="text-sm">
                                ...
                                <p className="text-gray-500">
                                  Register as a venue manager to be able to rent
